    ...
    <>
      ...
      <section className="relative pt-40 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <p className="text-[#F4E7C9] text-xs font-bold tracking-[0.3em] uppercase mb-3">Our Story</p>
      ...
      <section className="bg-[#0a0a0a] py-20 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative h-80 md:h-[420px] rounded-xl bg-[#141414] border border-white/5 flex items-center justify-center">
            ...
            <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#F4E7C9] to-transparent" />
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#0f0f0f] py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-[#F4E7C9] text-xs font-bold tracking-[0.3em] uppercase mb-3">Our Values</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((v) => (
              <div key={v.title} className="card-hover bg-[#141414] border border-white/5 rounded-xl p-8">
                <div className="w-10 h-10 bg-[#F4E7C9]/10 border border-[#F4E7C9]/30 rounded-lg flex items-center justify-center mb-5">
                  <div className="w-3 h-3 bg-[#F4E7C9] rounded-full" />
                </div>
      ...
      <section className="bg-[#0a0a0a] py-24 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-[#F4E7C9] text-xs font-bold tracking-[0.3em] uppercase mb-3">Where We Work</p>
